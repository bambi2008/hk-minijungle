...
const requiredIds = [
  ...
  "customer-case-trend-bar",
  "customer-case-timeline-list",
  "confidence-value",
  "confidence-bar",
  "confidence-label",
  ...
  "native-camera-shot-btn",
  "native-camera-close-btn",
  "native-camera-status",
  "save-log-btn",
  "followupPhoto",
  "followup-loop-card",
  "followup-loop-title",
  ...
  "public-photo-test-metrics",
  "public-photo-test-list",
  "public-photo-test-log",
  "refresh-public-photo-test-btn",
  "export-public-photo-test-btn",
  "reset-public-photo-test-btn",
...
const requiredJsSnippets = [
  ...
  "function renderCropIdentityBlock",
  "function shouldBlockDiagnosisForRealVision",
  "function renderRealVisionBlock",
  "retry-real-vision",
  "FiveCrop 不会用本地规则冒充识别",
  "这次复查没有保存",
  "Crop not confirmed",
  ...
  "function customerFirstPhotoPrompt",
  "function setCustomerFirstPhotoReady",
  "function setCustomerPhotoPickerOpen",
  "function scheduleCustomerPhotoPickerCancelCheck",
  ...
  "function photoQualityGate",
  "function renderPhotoReview",
  "function buildAiPipelineSnapshot",
  "function updateAiPipelineSnapshot",
  "function openNativeCamera",
  "function captureNativeCameraFrame",
  "function stopNativeCamera",
  "getUserMedia",
  "native-camera-open",
  "function processPlantPhotoDataUrl",
  ...
  "function setPhotoProcessingState",
  ...
  "function hasCustomerDossierContext",
  "function renderCustomerStartPanel",
  ...
  "async function refreshCustomerCaseTimeline",
  "function mergeCustomerTimelineEvents",
  ...
  "customer-dossier-continue-btn",
  "已准备记录新植物",
  "function customerArchiveSignature",
  "function maybeAutoArchiveCustomerDiagnosis",
  "function restoreCustomerArchiveOnStartup",
  "function renderCustomerArchiveStatus",
  "customerAutoArchiveKey",
  "archiveSource: \"customer-first-diagnosis\"",
  "已为这棵植物建档",
  "已恢复上次植物档案",
  "restoreCustomerArchiveOnStartup();",
  "localStorage.removeItem(customerAutoArchiveKey)",
  "function handleCustomerPrimaryAction",
  "function careGuidanceStagePlan",
  "model.guidanceKey || \"default\"",
  "careModel.completed ? \"followup-panel\" : \"care-complete\"",
  "customerCompactActionBtn",
  "customer-plan-compact",
  "customer-compact-followup",
  ...
  "function openPhotoRescueUpload",
  "customerPhotoRescueActions",
...
const requiredCssSnippets = [
  ...
  "body.customer-mode .customer-journey",
  ...
  ".customer-case-timeline-event.action",
  ...
  "body.customer-mode.customer-first-photo-ready #quick-photo-btn",
  "body.customer-mode.customer-photo-picker-open #quick-photo-btn",
  "body.customer-mode .guided-photo-card",
  "body.customer-mode.customer-dossier-active .guided-photo-card",
  "body.customer-mode .crop-quick-start",
  ".customer-photo-rescue-actions",
  ".rescue-action-button.primary-action",
  ".soft-focus",
  ".customer-journey-list",
