...
## Preventive work-order handoff

The phone route consumes ordinary work orders only after an active workforce assignment exists. Preventive work generated by the planning service therefore follows the same execution, offline capture, proof and FM review path as imported or manually created work. The phone must never infer an assignment from a maintenance plan alone.
