...
async function main() {
  ...
  try {
    ...
    try {
      ...
      await operations.locator("#remediation-submit").click();
      await operations.waitForFunction(() => document.querySelector("#timeline-list")?.textContent.includes("remediation.task.review-approved"), null, { timeout: 30000 });
      ...
      await operations.waitForFunction(() => document.querySelector("#inventory-notice")?.textContent.includes("approved"), null, { timeout: 30000 });
